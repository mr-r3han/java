...
class AxisBank extends AllBank {

    private static AxisBank axisObject = null;  

    long balance = 15000;

    public void axisOperation(){
        Scanner in = new Scanner(System.in);
        
        while(true){
            if(blockCount == 3) break;
            System.out.println(ANSI_YELLOW+"===================Welcome back to Axis Bank==================="+ANSI_RESET);
            ...
            try{
                ...
                if(res==1){
                    ...
                    System.out.println(ANSI_YELLOW+"=====================Thanks for using Axis Bank================================"+ANSI_RESET);
                    break;
                }else{
    ...
    public void bankBalance(){
        while(true){
            ...
            try{
                ...
                System.out.print("Please enter Axis Bank UPI pin to check Balance : ");
                int axisPinUser = in.nextInt();
                PhoneMain pm = PhoneMain.PhonePayObject();
                if(axisPinUser != pm.getAxisPin()){
    ...
    public static AxisBank getAxisObject(){
        if(axisObject==null){
            axisObject = new AxisBank();
        }
        return axisObject;
    }
}
